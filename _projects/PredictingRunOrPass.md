...
Now we can start playing with some machine learning algorithms! We'll start with <a href = "http://matsarj.github.io/blogs/Logistic-Regression">logistic regression</a>. With sklearn it is as simple as running the following code:
